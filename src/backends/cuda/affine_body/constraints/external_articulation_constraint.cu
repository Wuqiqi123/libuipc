...
namespace
{
        ...
        int                                     n)
    {
        ...
        // Cross-joint blocks have different row/column body sets. The full
        // mass matrix includes (j,i), so write only the global upper triangle.
